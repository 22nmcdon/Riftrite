...
5. The day structure (Caravan, stop, fight, losses and replays) and the economy data; the run bot and run-level balance reports. (plan: `docs/plans/day-structure.md`)
6. Boss mechanic(s).
